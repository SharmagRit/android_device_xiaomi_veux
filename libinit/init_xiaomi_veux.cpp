...
static const variant_info_t veux_info = {
    ...
    .model = "2201116SC",
    .name = "veux",
    .build_fingerprint = "Redmi/veux/veux:11/RKQ1.211001.001/V13.0.14.0.RKCMIXM:user/release-keys",
...
static const variant_info_t peux_in_info = {
    ...
    .model = "2201116SI",
    .name = "peux_in",
    .build_fingerprint = "Redmi/peux_in/peux:11/RKQ1.211001.001/V13.0.14.0.RKCMIXM:user/release-keys",
};
...
static const variant_info_t veux_jp_info = {
    ...
    .model = "2201116SR",
    .name = "veux_jp",
    .build_fingerprint = "Redmi/veux_jp/veux:11/RKQ1.211001.001/V13.0.14.0.RKCMIXM:user/release-keys",
...
static const variant_info_t peux_p_in_info = {
    ...
    .model = "2201116PI",
    .name = "peux_p_in",
    .build_fingerprint = "POCO/peux_p_in/peux:11/RKQ1.211001.001/V13.0.14.0.RKCMIXM:user/release-keys",
};
